...
import br.com.kayCompany.Monalisa.dtos.compra.DadosInnerJoinCompra;
...
public interface CompraRepository extends JpaRepository<Compra, Long> {
    ...
    @Query("""
            select new br.com.kayCompany.Monalisa.dtos.compra.DadosInnerJoinCompra(cm.id, cn.id, cm.estabelecimento, cm.valor, cm.data, f.id)
            from Fatura f
